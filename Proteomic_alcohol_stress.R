...
write.xlsx(datos/estadística_stress_BR16_machos.xlsx", sheetName = "Desrreguladas")
...
write.xlsx(df_desrreguladas, "alcohol/tercera-vuelta/definitivo/BR-16/BR-16_Proteomica/Proteómica_alcohol_stress/efecto_alcohol_stress_BR16_machos.xlsx", sheetName = "Desrreguladas")
write.xlsx(vulcanot, "alcohol/tercera-vuelta/definitivo/BR-16/BR-16_Proteomica/Proteómica_alcohol_stress/estadistica_entera_alcohol_stress_BR16_machos.xlsx", sheetName = "todas")
...
print(tu_grafico)  
ruta_archivo <- "alcohol/tercera-vuelta/definitivo/BR-16/BR-16_Proteomica/Proteómica_alcohol_stress/efecto_alcohol_stress_BR16_machos.png"
...
br_16_alcohol_stress <- read_excel("alcohol/tercera-vuelta/definitivo/BR-16/BR-16_Proteomica/Proteómica_alcohol_stress/RED_ALCOHOL_STRESS.xlsx")
...
ruta_archivo <- "alcohol/tercera-vuelta/definitivo/BR-16/BR-16_Proteomica/Proteómica_alcohol_stress/red_alcohol_stress.png"
ggsave(filename = ruta_archivo, plot = last_plot(), device = "png", width = 10, height = 10)
...
legend("bottomright", fill=c("blue", "red"), legend=levels(sample_metadata$stress.alcohol))
